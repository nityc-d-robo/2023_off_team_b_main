...
static const _MdLibMsg_type_support_symbol_names_t _MdLibMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, drobo_interfaces, msg, MdLibMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, drobo_interfaces, msg, MdLibMsg)),
  }
};
...
{
  return &::drobo_interfaces::msg::rosidl_typesupport_cpp::MdLibMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, drobo_interfaces, msg, MdLibMsg)() {
  return get_message_type_support_handle<drobo_interfaces::msg::MdLibMsg>();
}
